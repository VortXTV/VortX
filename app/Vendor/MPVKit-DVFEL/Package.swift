...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Libmpv-GPL",
            path: "artifacts/Libmpv-GPL.xcframework"
        ),
        .binaryTarget(
            name: "Libavcodec-GPL",
            path: "artifacts/Libavcodec-GPL.xcframework"
        ),
        .binaryTarget(
            name: "Libavdevice-GPL",
            path: "artifacts/Libavdevice-GPL.xcframework"
        ),
        .binaryTarget(
            name: "Libavformat-GPL",
            path: "artifacts/Libavformat-GPL.xcframework"
        ),
        .binaryTarget(
            name: "Libavfilter-GPL",
            path: "artifacts/Libavfilter-GPL.xcframework"
        ),
        .binaryTarget(
            name: "Libavutil-GPL",
            path: "artifacts/Libavutil-GPL.xcframework"
        ),
        .binaryTarget(
            name: "Libswresample-GPL",
            path: "artifacts/Libswresample-GPL.xcframework"
        ),
        .binaryTarget(
            name: "Libswscale-GPL",
            path: "artifacts/Libswscale-GPL.xcframework"
        ),
        ...
        .binaryTarget(
            name: "Libplacebo",
            path: "artifacts/Libplacebo.xcframework"
        ),
