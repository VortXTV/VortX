...
```bash
xcrun simctl terminate "$UDID" com.stremiox.tv 2>/dev/null || true
xcrun simctl launch --terminate-running-process \
  --setenv VORTX_DEBUG_PLAY_URL="http://<host>:<port>/fixture.mkv" \
  --setenv VORTX_DEBUG_PLAY_TITLE="Conformance Run" \
  "$UDID" com.stremiox.tv
```
